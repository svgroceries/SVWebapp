		...
		<div class="container-fluid">
			<div class="row">
				 <div class="columns  col-xs-12 col-sm-3">
				  <ul class="price">
				    <li class="header">Cosmetics 1</li>
				    <li>COSMETICS</li>
				    <li>COSMETICS</li>
				    <li>COSMETICS</li>
				    <li>COSMETICS</li>
			 	...
			 	<div class="columns  col-xs-12 col-sm-3">
				  <ul class="price">
				    <li class="header">Cosmetics 2</li>
				    <li>COSMETICS</li>
				    <li>COSMETICS</li>
				 </ul>
				</div> 
				<div class="columns  col-xs-12 col-sm-3">
				  <ul class="price">
				    <li class="header">Cosmetics 3</li>
				    <li>COSMETICS</li>
				    <li>COSMETICS</li>
				    <li>COSMETICS</li>
				    <li>COSMETICS</li>
				...
				<div class="columns  col-xs-12 col-sm-3">
				  <ul class="price">
				    <li class="header" style="background-color:#4CAF50">Cosmetics 4</li>
				    <li>COSMETICS</li>
				  </ul>
				</div>
			</div>
